                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-start mt-3">
                            <div>
                                <button type="button" class="btn btn-secondary" onclick="location.href='/form-dokumen/add'">
...
<!-- MODAL DELETE -->
<script>
    function deletedokumenConfirmation(id) {
        Swal.fire({
