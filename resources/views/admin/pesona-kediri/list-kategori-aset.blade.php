            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Kategori Aset</h4>
...
<div class="modal fade" id="add" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="/update-kategori-aset" method="POST" enctype="multipart/form-data" id="formadd">
            @csrf
...
<script>
    ...
    function edit(id) {
        $.ajax({
            type: 'GET',
            url: "{{ url('/value-kategori-aset') }}/" + id,
            dataType: 'json',
    ...
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url:  "{{ url('/hapus-kategori-aset') }}/" + id,
                    data: {
                            _token: CSRF_TOKEN
                        },
                    dataType: 'JSON',
