                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-start mt-3">
                            <div>
                                <button type="button" class="btn btn-secondary" onclick="location.href='/form-pengumuman/add'">
 ...
 <script type="text/javascript">
    $(function() {
        var table = $('.table-bordered').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{ route('list_pengumuman') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', className: 'text-center'},
                {data: 'judul', name: 'judul', className: 'text-center',  width: '25%'},
...
<!-- MODAL DELETE -->
<script>
    function deletepengumumanConfirmation(id) {
        Swal.fire({
